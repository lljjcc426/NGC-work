...
- assignment_cost: `3905`
- assignment_points: `16.729987`
- current_cost: `2949.0`
- current_score: `17.010778591184724`
...
- train/test/arc-gen: `2/1/261`
- input_shapes: `10x10`
- output_shapes: `10x10`
- same_shape_all_examples: `True`
- output_colors_subset_input: `True`
- avg_changed_cell_ratio_same_shape: `0.2198`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task069 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task069`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task069 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
