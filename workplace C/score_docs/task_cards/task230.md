...
- assignment_cost: `900`
- assignment_points: `18.197605`
- current_cost: `900.0`
- current_score: `18.197605236675688`
...
- input_shapes: `10x10;15x15`
- output_shapes: `10x10;15x15`
- same_shape_all_examples: `True`
- output_colors_subset_input: `False`
- avg_changed_cell_ratio_same_shape: `0.0770`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task230 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task230`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task230 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
