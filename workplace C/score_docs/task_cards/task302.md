...
- assignment_cost: `1774`
- assignment_points: `17.519008`
- current_cost: `1774.0`
- current_score: `17.519007837130474`
...
- avg_changed_cell_ratio_same_shape: `0.0772`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task302 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task302`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task302 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
