...
- assignment_cost: `180`
- assignment_points: `19.807043`
- current_cost: `180.0`
- current_score: `19.807043149109788`
...
- input_shapes: `10x10;11x11;12x12;13x13;14x14;15x15;3x3;4x4;5x5;6x6;7x7;8x8;9x9`
- output_shapes: `10x10;11x11;12x12;13x13;14x14;15x15;3x3;4x4;5x5;6x6;7x7;8x8;9x9`
- same_shape_all_examples: `True`
- output_colors_subset_input: `False`
- avg_changed_cell_ratio_same_shape: `0.0593`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task252 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task252`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task252 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
