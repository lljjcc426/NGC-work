...
- assignment_cost: `1229`
- assignment_points: `17.886044`
- current_cost: `1229.0`
- current_score: `17.886043890433967`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task351 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task351`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task351 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
