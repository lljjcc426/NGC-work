...
- assignment_cost: `267`
- assignment_points: `19.412751`
- current_cost: `265.0`
- current_score: `19.42027017401378`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task146 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task146`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task146 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
