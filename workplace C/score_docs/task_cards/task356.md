...
- assignment_cost: `1319`
- assignment_points: `17.815371`
- current_cost: `1319.0`
- current_score: `17.815370847282686`
...
- avg_changed_cell_ratio_same_shape: `0.0647`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task356 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task356`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task356 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
