...
- assignment_cost: `326`
- assignment_points: `19.213103`
- current_cost: `326.0`
- current_score: `19.213102618633293`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task121 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task121`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task121 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
