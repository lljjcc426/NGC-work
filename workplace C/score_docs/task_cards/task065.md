...
- assignment_cost: `638`
- assignment_points: `18.541662`
- current_cost: `638.0`
- current_score: `18.54166171665521`
...
- input_shapes: `11x11;13x13;15x15;3x3;5x5;7x7;9x9`
- output_shapes: `1x1;2x2;3x3;4x4;5x5;6x6;7x7`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task065 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task065`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task065 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
