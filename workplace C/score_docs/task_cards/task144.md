...
- assignment_cost: `104`
- assignment_points: `20.355609`
- current_cost: `104.0`
- current_score: `20.35560910085863`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task144 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task144`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task144 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
