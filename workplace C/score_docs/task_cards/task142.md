...
- assignment_cost: `90`
- assignment_points: `20.50019`
- current_cost: `90.0`
- current_score: `20.500190329669735`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task142 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task142`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task142 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
