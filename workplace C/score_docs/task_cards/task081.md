...
- assignment_cost: `464`
- assignment_points: `18.860115`
- current_cost: `464.0`
- current_score: `18.860115447773744`
...
- avg_changed_cell_ratio_same_shape: `0.0490`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task081 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task081`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task081 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
