...
- assignment_cost: `6699`
- assignment_points: `16.190286`
- current_cost: `6694.0`
- current_score: `16.191033118228727`
...
- input_shapes: `17x17;20x20;23x23;26x26;29x29`
- output_shapes: `17x17;20x20;23x23;26x26;29x29`
- same_shape_all_examples: `True`
- output_colors_subset_input: `True`
- avg_changed_cell_ratio_same_shape: `0.0533`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task009 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task009`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task009 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
