...
- assignment_cost: `805`
- assignment_points: `18.309158`
- current_cost: `805.0`
- current_score: `18.309157722581435`
...
- input_shapes: `3x3`
- output_shapes: `12x12;15x15;18x18;21x21;9x9`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task221 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task221`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task221 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
