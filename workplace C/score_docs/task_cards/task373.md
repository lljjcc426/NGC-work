...
- assignment_cost: `60`
- assignment_points: `20.905655`
- current_cost: `60.0`
- current_score: `20.9056554377779`
...
- train/test/arc-gen: `2/1/72`
- input_shapes: `2x6`
- output_shapes: `2x6`
- same_shape_all_examples: `True`
- output_colors_subset_input: `True`
- avg_changed_cell_ratio_same_shape: `0.5000`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task373 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task373`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task373 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
