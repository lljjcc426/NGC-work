...
- assignment_cost: `1031`
- assignment_points: `18.061716`
- current_cost: `1031.0`
- current_score: `18.06171551598304`
...
- avg_changed_cell_ratio_same_shape: `0.3055`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task225 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task225`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task225 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
