...
- assignment_cost: `710`
- assignment_points: `18.434735`
- current_cost: `710.0`
- current_score: `18.43473502996464`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task372 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task372`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task372 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
