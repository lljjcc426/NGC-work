...
- assignment_cost: `135`
- assignment_points: `20.094725`
- current_cost: `135.0`
- current_score: `20.09472522156157`
...
- train/test/arc-gen: `3/2/262`
- input_shapes: `6x6;8x8`
- output_shapes: `6x6;8x8`
- same_shape_all_examples: `True`
- output_colors_subset_input: `True`
- avg_changed_cell_ratio_same_shape: `1.0000`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task298 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task298`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task298 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
