...
- assignment_cost: `2703`
- assignment_points: `17.097882`
- current_cost: `2677.0`
- current_score: `17.10754795647965`
...
- avg_changed_cell_ratio_same_shape: `0.1817`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task094 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task094`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task094 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
