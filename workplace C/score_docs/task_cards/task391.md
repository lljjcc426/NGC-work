...
- assignment_cost: `159`
- assignment_points: `19.931096`
- current_cost: `159.0`
- current_score: `19.93109579777977`
...
- input_shapes: `13x10;13x13;13x16;15x10;15x13;15x16`
- output_shapes: `3x1`
...
1. `python "workplace C/neurogolf-2026-work/scripts/c_score_scan_artifacts.py" --tasks task391 --score-top-n 8 --full-validate`
2. Inspect best lower-size artifacts in `workplace C/score_docs/artifact_scans/` and compare memory/params split for `task391`.
3. If a lower-cost artifact validates, register it with `c_cost_diff_runner.py --task task391 --old-artifact <current> --new-artifact <candidate> --accept-if-better`.
